...
В случае, если страница фронтенда работате некорректно нажать CTRL+F5.
...
Полностью реализован импорт проектов с предварительной валидацией. Экспорт происходит автоматически после нажатия соответствующей кнопки.
