...
.admin-btn:hover {
    ...
    background-color: #ffffff;
    transform: translateY(-2px);
    box-shadow: 0 4px 12px rgba(192, 91, 240, 0.1);
}
...
/* Popup Overlay - исправленные стили */
.popup-overlay {
    position: fixed;
    top: 0;
    left: 0;
...
.login-submit {
    width: 100%;
    padding: 16px;
    background: linear-gradient(to bottom left, #2394F9, #BF43A9);
    color: white;
    border: none;
    border-radius: 12px;
    font-size: 18px;
