...
app.post('/api/projects', async (req, res) => {
    try {
        const { name, description, statusId, priorityId, managerId, startDate, deadlineDate, progress, clientName, clientContact, tags } = req.body;
...
app.put('/api/projects/:id', async (req, res) => {
    try {
        const { id } = req.params;
        const { name, description, statusId, priorityId, managerId, startDate, deadlineDate, actualStartDate, actualEndDate, budget, spentHours, progress, clientName, clientContact, tags } = req.body;
